...
class SuperDeduper {
	...
	public function getNoiseWords() {
		...
		$noise_words['en'] = array(
			...
			'always', 'am', 'am', 'an', 'and', 'another', 'any', 'anybody',
			'anyhow', 'anyone', 'anything', 'anyway', 'are', 'are', 'as', 'at',
			'away', 'back', 'be', 'became', 'because', 'been', 'before',
			'being', 'between', 'but', 'by', 'came', 'can', 'cannot', 'come',
			'could', 'did', 'do', 'does', 'does', 'doing', 'done', 'down',
			'each', 'else', 'even', 'ever', 'every', 'everyone', 'everything',
			'for', 'from', 'front', 'get', 'getting', 'go', 'goes', 'going',
			'gone', 'got', 'gotten', 'had', 'has', 'has', 'have', 'have',
			'having', 'he', 'her', 'here', 'him', 'his', 'how', 'i', 'if',
			'in', 'into', 'is', 'is', "isn't", 'it', 'just', 'last', 'least',
			'left', 'less', 'let', 'like', 'make', 'many', 'may', 'maybe',
			'me', 'mine', 'mine', 'more', 'most', 'much', 'my', 'myself',
			'never', 'no', 'none', 'not', 'now', 'of', 'off', 'on', 'one',
			'onto', 'or', 'our', 'ourselves', 'out', 'over', 'per', 'put',
			'putting', 'same', 'saw', 'see', 'seen', 'shall', 'shall', 'she',
			'she', 'should', 'should', 'so', 'some', 'somebody', 'someone',
			'something', 'stand', 'such', 'sure', 'take', 'than', 'that',
			'the', 'their', 'their', 'them', 'them', 'then', 'there', 'these',
			'they', 'this', 'this', 'those', 'through', 'till', 'to', 'too',
			'two', 'unless', 'until', 'up', 'upon', 'us', 'us', 'very', 'was',
			'was', 'we', 'went', 'were', 'were', 'what', "what's", 'whatever',
			'when', 'where', 'whether', 'which', 'while', 'who', 'who',
			'whoever', 'whom', 'whose', 'whose', 'why', 'will', 'will', 'with',
			'within', 'without', "won't", 'would', "wouldn't", 'yet', 'you',
			'your',
		);

		/** German (Deutsch) */
		$noise_words['de'] = array(
			'alle', 'alles', 'als', 'am', 'beachten', 'bedeuten', 'bedeutet',
			'bei', 'beste', 'besten', 'bezeichnen', 'bezeichnet', 'bieten',
			'bietet', 'bin', 'bis', 'bleiben', 'bleibt', 'brauchen', 'braucht',
			'bringen', 'circa', 'das', 'dein', 'deine', 'der', 'die', 'diese',
			'dieser', 'egal', 'eigen', 'eigene', 'ein', 'eine', 'einer', 'er',
			'es', 'etwa', 'etwas', 'fast', 'funktionieren', 'funktioniert',
			'für', 'geben', 'gehören', 'gehört', 'gibt', 'gut', 'gute', 'haben',
			'hat', 'heißen', 'heißt', 'hinter', 'ich', 'ihr', 'ihre', 'im',
			'immer', 'in', 'inwiefern', 'inwieweit', 'ist', 'jede', 'jeder',
			'jemand', 'kann', 'kommen', 'kommt', 'können', 'könnte', 'lange',
			'lassen', 'lässt', 'machen', 'man', 'mehr', 'mein', 'mein',
			'meine', 'meiner', 'möglich', 'muss', 'müssen', 'müsste', 'nach',
			'nennen', 'nennt', 'nicht', 'nie', 'noch', 'nur', 'oder',
			'passieren', 'passiert', 'plötzlich', 'schlechte', 'sein',
			'seine', 'selten', 'sie', 'sinnvoll', 'so', 'tun', 'tut', 'über',
			'unbedingt', 'und', 'uns', 'viel', 'von', 'vor', 'vorher', 'wann',
			'warum', 'was', 'weg', 'weil', 'welche', 'welcher', 'wenig',
			'weniger', 'wer', 'werden', 'weshalb', 'wie', 'wieder', 'wielange',
			'wieso', 'wird', 'wo', 'zu', 'zurück', 'zwischen'
		);

		/** French (Français) */
		$noise_words['fr'] = array(
			'le', 'la', 'les', 'du', 'de', 'des', 'une', 'un', 'mon', 'ton',
			'son', 'ma', 'ta', 'sa', 'mes', 'tes', 'ses', 'notre', 'votre',
			'leur', 'nos', 'vos', 'leurs'
		);

		/** Italian (Italiano) */
		$noise_words['it'] = array(
			'a', 'ai', 'al', "all'", 'alla', 'alle', 'allo', 'avete', 'chi',
			'chiunque', 'come', 'comunque', 'cosa', 'da', 'dagli', 'dai',
			'dal', "dall'", 'dalla', 'dalle', 'del', 'dei', 'di', 'dove',
			'dovunque', 'è', 'é', 'fa', 'faccio', 'gli', 'ha', 'hai', 'ho',
			'i', 'il', 'la', 'le', 'lo', 'ma', 'mai', 'nessuna', 'nessuno',
			'no', 'non', 'per', 'perchè', 'perché', 'però', 'posso', 'potete',
			'può', 'puoi', 'qual', "qual'", 'quale', 'quali', 'quando',
			'quasi', 'se', 'si', 'sempre', 'sono', 'stessa', 'stesse',
			'stessi', 'stesso', 'tutta', 'tutte', 'tutti', 'tutto', 'un' "un'",
			'una', 'uno', 'vista', 'viste', 'visto'
		);
...
function getMediaWikiDB( $dbname ) {
	...
	// Yes, I wish I could have used the MediaWiki stack here.
	// Too bad it's not high performance enough so we will have to live with
	// duplicated configs
	// Update: THERE IS A YAML FILE WITH THE CORRECT CONFIGS.
	// SHOULD PARSE THAT TO GET THIS INFO.
