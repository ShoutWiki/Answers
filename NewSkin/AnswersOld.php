<?php
/**
 * Answers skin -- old and original version
 *
 * @file
 * @ingroup Skins
...
$wgExtensionCredits['skin'][] = array(
	...
	'description' => 'The original Answers skin, based on Monaco',
...
// The first instance must be strtolower()ed so that useskin=answersold works and
// so that it does *not* force an initial capital (i.e. we do NOT want
// useskin=Answersold) and the second instance is used to determine the name of
// *this* file.
$wgValidSkinNames[strtolower( $skinID )] = 'AnswersOld';

$wgAutoloadClasses['SkinAnswersOld'] = $dir . 'OldSkin.skin.php';
