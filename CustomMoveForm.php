	...
	function showForm( $err ) {
		...
		$wgOut->addHTML(
			Xml::openElement(
				'form',
				array(
					'onsubmit' => 'this.wpNewTitle.value=this.wpNewTitle.value.replace(/\?/g,\'\')',
					'method' => 'post',
		...
		if (
			( $this->oldTitle->hasSubpages() || $this->oldTitle->getTalkPage()->hasSubpages() ) &&
