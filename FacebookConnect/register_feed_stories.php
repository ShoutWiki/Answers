...
$short_story_templates[] = array(
	'template_title' => '{*actor*} wants to know "<a href="{*url*}">{*question*}</a>" at Wikianswers',
	'template_body' => 'There can be a lot more text here. Possibly a blurb about Wikianswers. Or whatever.'
);
$action_links[] = array(
...
$form_id = facebook_client()->api_client->feed_registerTemplateBundle(
	$one_line_stories_templates,
